...
class AppTheme {
    ...
    class func apply() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName: UIColor.whiteColor(), NSFontAttributeName: defaultMediumFont?.fontWithSize(18.0) ?? UIFont.boldSystemFontOfSize(18.0)]
